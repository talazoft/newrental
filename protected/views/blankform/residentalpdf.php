...
<body>
 <div class="maincontent_info">
    	...
    	<div class="head_content">
            <div class="logo-info">
                <img src="<?php echo Yii::app()->baseUrl; ?>/image/logo.png" />
            </div>
          ...
          <div class="formulir1">
			...
			<div class="judul_dalam">OTHER CONTACT INFORMATION</div>               	         
             ...
             <table>
             <tr>
                 <td><p style="text-align: justify"><font size="2">The undersigned Applicant hereby offers to rent/lease real property described as PROPERTY NAME
...
all information to other property owners/managers, credit grantors and/or public agencies</font></p>
                <p><font size="2">Yes I agree with all term of use</font></p>
